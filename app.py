...
import pickle
model = pickle.load(open('D:\Car_Price_Prediction-main\Car_Price_Prediction-main\RF_price_predicting_model.pkl','rb'))
def main():
    ...
    Present_Price = st.number_input('What is the current ex-showroom price of the car ?  (In Rs.lakhs)', 0.00, 50.00, step=0.5, key ='present_price')
